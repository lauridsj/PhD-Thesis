...
\begin{figure}
    ...
    \caption{\textbf{The CMS detector}. A cross section view of the different CMS subdetectors, with the trajectories of example particles and their interactions. This figure is taken from \citere{CMS:detector_slice}.}
\end{figure}
...
\textit{Muons} do not interact with the calorimeter, and are instead are built by directly combining charged tracks with hits in the muon chambers. In this work, muons are only considered if they match to hits in both subdetectors.
