...
\noindent where $\hat{\theta}$ is the best-fit value of the NP, $\theta_0$ is the prefit value, and $\Delta \theta_0$ is the prefit uncertainty.  To have a NP pulled thus means that its best-fit value is different from the prefit expectation. Similarly, the \textit{constraint} of the NP is defined as
