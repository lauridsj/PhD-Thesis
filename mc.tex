...
A way to approximately incorporate these emissions is by using parton showers, the idea of which is sketched in the following. %The idea of a parton shower is to successively generate all real emissions and splittings down to the scale of $\Lambda_{\mathrm{QCD}}$.
