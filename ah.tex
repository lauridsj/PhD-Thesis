...
\begin{figure}[th]
    ...
    \caption{
        \textbf{Parity of the excess}. Expected and observed exclusion contours in a simultaneous fit of \etat (corresponding to \term{1}{S}{0}) and \chit (corresponding to \term{3}{P}{0}). \textit{Figure adapted from \citere{CMS:TOP-24-007}}. \todo{update colors}
    }
