...
This variable encodes the transverse momentum density of the particles making up the b jet as a function of its radius $R$, normalized to its total transverse momentum.
