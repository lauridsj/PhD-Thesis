...
For the cross sections of the different processes, log-normal rate uncertainties are assigned based on the process and order at which it was calculated. A 15\% uncertainty is used for the {single-$t$} background since it is generated at NLO with a NNLO prediction for the cross section, while
